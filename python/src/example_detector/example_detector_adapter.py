...
from example_detector.example_detector_controller import ExampleDetectorController


class ExampleDetectorAdapter(ApiAdapter):
    ...
    def __init__(self, **kwargs):
        ...
        super(ExampleDetectorAdapter, self).__init__(**kwargs)
